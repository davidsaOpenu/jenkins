...
# Usage: ./customize-vm.sh <image-file> <username>

IMAGE=$1
USERNAME=$2

if [ -z "$IMAGE" ] || [ -z "$USERNAME" ]; then
    echo "Usage: $0 <image-file> <username>"
    echo "Example: $0 ubuntu-22.04.qcow2 stack"
    exit 1
fi
...
# Install jq for JSON parsing in the test script
